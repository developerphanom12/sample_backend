...
export const inviteNewMemberMailSes = (data: IInviteMember) => {
  const { companyNames, email, memberEmail, host_url, name, token, avatarSrc } =
    data;
  ...
  return {
    ...
    <html>
      ...
      isOneCompany ? 'company' : 'companies'
    }
                              </p>
                              ...
                              <p style="font-family:'Open Sans', sans-serif;color:#0092DB;text-decoration:underline;font-size:16px;line-height:22px;margin:0;padding-bottom:5px;font-weight:600;text-align:center;" class="mobile_paragraph">
                                ${memberEmail}
                              </p>
                              <p style="font-family:'Open Sans', sans-serif;font-size:16px;line-height:30px;margin:0;padding-bottom:5px;padding-top:15px;text-align:center;" class="mobile_paragraph">
                                If you don't want accept this invitation, just ignore this email.
                              </p>
                            </td>
                          </tr>
                        </table>
