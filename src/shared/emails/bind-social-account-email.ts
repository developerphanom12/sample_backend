...
import { IResetPasswordMessage } from '../../emails/emails.service';

export const bindSocialAccMailSes = (data: IResetPasswordMessage) => {
  const { email, host_url, name, token } = data;
                          ...
                          <tr>
                            <td>
                              ...
                              <p style="padding-bottom:0px;" class="mobile_paragraph">
                                <a class="button_mobile" href=${host_url}auth/redirect_bind-social-account/${token} style="font-family:'Open Sans', sans-serif;display:block;background-color:#FF5252;border-radius:5px;padding:13.5px 16px;color:#F2F2F2;font-weight:400;text-decoration:none;margin:0 auto;text-align:center;max-width:180px;width:100%;">
                                  Create RH account
                                </a>
                              </p>
                            </td>
